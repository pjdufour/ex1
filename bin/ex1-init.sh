...
# Initialize PostGIS
sudo -u postgres psql -c "CREATE USER ex1 WITH ENCRYPTED PASSWORD 'ex1';"
...
sudo -u postgres psql -c "CREATE DATABASE ex1 ENCODING 'UTF8' TEMPLATE template_postgis;"
sudo -u postgres psql -d ex1 -c "ALTER DATABASE ex1 OWNER TO ex1;"
sudo -u postgres psql -d ex1 -c "GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA public TO ex1;"
